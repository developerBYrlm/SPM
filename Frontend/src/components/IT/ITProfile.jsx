...
const ITProfile = () =>{
  ...
  if (!student || !student.user) { return <div>No IT data found for ID: {id}</div> }

  return (
    <div className="main-content">
         <div className="dashboard-container">
         <h2 className="dashboard-title">  IT Profile Details</h2>
          ...
          <div className="ImageFrame">
           ...
           <div className="student-info">
            ...
            <p><strong>IT Acronym: </strong> {student.studentId}</p>
