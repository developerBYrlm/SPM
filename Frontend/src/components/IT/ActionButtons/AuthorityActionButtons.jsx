...
const AuthorityActionButtons = ({ id }) =>{
    ...
    <div className="action-btn-group">
      <button
        ...
        onClick={() => navigate(`/it-dashboard/authority/authority-view/${id}`)} 
      >
        View
      </button>
      ...
      <button
        ...
        onClick={() => navigate(`/it-dashboard/authority/authority-edit/${id}`)}
      >
        Edit
      </button>
...
export default AuthorityActionButtons;
