...
import AuthorityButtons from "./ActionButtons/AuthorityActionButtons"; // default import
...
const AuthorityList = () => {
  ...
  const columns = [
    ...
    { name: "Authority ID", selector: (row) => row.studentId, sortable: true, width: "170px" },
    {
      name: "Image",
      cell: (row) => (
        <img
    ...
    { name: "Department", selector: (row) => row.department, sortable: true, width: "170px" },
    {
      name: "Action",
      cell: (row) => <AuthorityButtons id={row._id} />, width: "290px", center: "true"
    },
  ];
  ...
  return (
    <div className="main-content">
      <div className="dashboard-container">
        <h2 className="dashboard-title">Manage Authority</h2>

        <div className="search-box glass">
          <input
              type="text"
             placeholder="Search by Authority Acronym"
             value={search}
